...
for videocount in range(1,2):
    #video-capture for the video frame reading..
    cap       =  cv2.VideoCapture("lirisaccede"+str(videocount)+".mkv")
    ret,image =  cap.read()
    ...
    fp.write("lirisaccede%d.mp4 ---- %d\n" % (videocount,(shot_cut_rate_final/(frame_count-1))))
